...
export const GET_USER_VISITED_PLACES = address + "/user/get-visited-places";
export const ADD_USER_VISITED_PLACE = address + "/user/add-visited-place";
export const ADD_PLACE_URL = address + "/place/addPlace"
